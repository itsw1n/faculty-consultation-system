    ...
    <main>
      <Section className="grid min-h-[70vh] place-content-center">
        <Container className="grid justify-items-center text-center">
          ...
          <Link
            className="inline-flex min-h-11 items-center rounded-lg bg-primary px-4 py-2 font-bold text-white hover:bg-primary-hover focus-visible:outline-3 focus-visible:outline-focus"
            href="/auth/continue"
          >
            Return to dashboard
          </Link>
