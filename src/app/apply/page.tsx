...
export default async function ApplyPage() {
  ...
  return <main className="grid min-h-screen place-items-center"><Section className="w-full"><Container><ApplicationFlow fullName={profile.fullName} email={profile.email} departments={departments}/></Container></Section></main>
}
